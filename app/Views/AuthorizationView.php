<div class="container" style="margin-top: 20px; padding: 10px; width: 485px; box-shadow: 0 0 10px rgba(0,0,150,0.5);">
    ...
    ?>
    <form role="form" method="post" action="Authorization/CheckUser">
